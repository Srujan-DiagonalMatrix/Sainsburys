 /***********************************************************************************************************************************************
* Filename:  005_ALTER_NER-400.sql
* Owner: Nectarine
* Author: Srujan K Alikanti
* Date: 11/03/2022
* Ticket Number: NER-400
  	...
  	var ins_overwrite_into_barcode_class=
		...
		SELECT
			...
			CASE
				...
				WHEN COUPON_REDEMPTION_TYPE=''5. Basket Value'' OR COUPON_REWARD_TYPE_CD=''pointsMultiplier'' THEN ''Basket''
				WHEN COUPON_REDEMPTION_TYPE IN (''1. Item Quantity'',''3. Value of Qualifying Items'') THEN ''Product''
				ELSE ''Unknown''
