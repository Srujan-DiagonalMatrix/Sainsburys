...
*************************************************************************************************************************************************/ 
 ...
 select 
  ...
  to_timestamp(OFFER_EFFECTIVE_DATE,'dd/MM/yyyy HH:MI:SS') as OFFER_EFFECTIVE_DATE,
  to_timestamp(OFFER_EXPIRATION_DATE,'dd/MM/yyyy HH:MI:SS') as OFFER_EXPIRATION_DATE,
  ...
  BARCODE::varchar(128) as BARCODE,
  to_timestamp(CREATEDATE,'dd/MM/yyyy HH:MI:SS') as CREATEDATE,
